...
class saviStep5Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.output2 = software + '/test_input_output/tmp2.vcf'
    ...
    def testNFitler(self):
        ...
        # run the function
        self.step5.filterNs(software + '/test_input_output/report.all.add_Ns.vcf', self.output2)

        # test that output has Ns removed
        self.assertTrue(filecmp.cmp(self.output2, software + '/test_input_output/report.all.remove_Ns.vcf'))
